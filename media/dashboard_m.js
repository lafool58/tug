...
const translatorData = {
    leedongjin: {
        ...
        sections: [
            ...
            },
            {
                ...
                text: "영화는 디즈니의 최근 3부작이 노출했던 과도한 CG와 볼거리 중심의 피로감에서 벗어나, 스타워즈 오리지널 3부작이 사랑받았던 거칠고 투박한 아날로그 프로덕션 질감과 미니어처적 정서적 매력을 현대적 감각으로 재탄생시킨 데 가장 큰 성취가 있다. 딘 자린의 차가운 베스카 갑옷과 그로구의 보드라운 감각이 맞닿는 손길, 깊은 침묵 속에서 오가는 시선과 온화한 제스처 하나만으로도 신파적인 대사 없이 깊은 울림을 전한다. 포스를 사용할 때 그로구가 뿜어내는 정서적 긴장감은 관객의 감정적 온도를 서서히 끌어올리며, 클라이맥스에서의 포스 배리어 생성 씬은 클래식 스타워즈 팬들이 갈구했던 온전히 회복된 우주적 판타지의 경이로운 쾌감을 안겨준다."
            },
            {
    ...
    justinchang: {
        ...
        sections: [
            {
                title: "🌌 시네마틱 스케일과 인간적 유대의 마법 같은 공존",
    ...
    guardian: {
        ...
        sections: [
            ...
            },
            {
                ...
                text: "특히 영화 전체를 관통하는 루트비히 요란손의 묵직하고 서정적인 메인 클래식 테마와 거대한 오케스트레이션 사운드는 아이맥스의 압도적인 영상과 완벽하게 맞물려 관객의 감각을 사로잡습니다. 아날로그 미니어처와 최첨단 스테이지 크래프트 기술을 결합하여 완성해 낸 다양한 은하계 도시와 모래 언덕, 신비한 포스의 사원 등은 단순한 그래픽을 넘어 실제 살아 숨 쉬는 공간 같은 생생한 리얼리티를 확보했습니다. 이는 관객이 딘 자린과 그로구의 비행선 조종석에 함께 앉아있는 듯한 경이로운 몰입감을 줍니다."
            },
            {
        ...
        sections: [
            {
                ...
                text: "IndieWire의 데이비드 에를리치는 연상호 감독이 <반도> 이후 다시 한번 스케일을 키워 돌아왔음을 환영했습니다. 폐허가 된 도심의 고층 빌딩에서 벌어지는 좀비들의 집단 이동은 단순한 CG의 향연이 아니라, 마치 현대 무용을 보는 듯한 기괴하고도 아름다운 '안무(choreography)'라고 극찬했습니다."
            },
            {
        ...
        sections: [
            {
                ...
                text: "《디스클로저 데이》(2026)는 스필버그가 반세기에 걸쳐 축적해 온 SF 장르적 혜안과 휴머니즘의 정수를 집대성한 필생의 역작이다. 영화는 외계 존재의 공식 선포(Disclosure) 직전의 차가운 긴장감을 2.39:1 화면비 가득 압도적인 콘트라스트로 담아낸다. 거장은 빛 and 어둠의 정교한 매칭, 미니어처 느낌의 아날로그 프로덕션 텍스처를 통해 현대 컴퓨터 그래픽 중심 SF의 피로감을 영리하게 타파해 낸다."
            },
            {
    ...
    disclosure_guardian: {
        ...
        sections: [
            {
                title: "🛸 현대 공상과학 스펙터클의 이정표이자 클래식의 장엄한 찬가",
                text: "피터 브래드쇼 평론가는 이 신작을 '과도한 CG와 볼거리 중심의 지루한 프랜차이즈 시장에 스필버그가 던지는 묵직한 경종'이라고 해석했습니다. 아날로그적 온기와 찬란하게 쏟아지는 백색 도광 연출, 인물들의 내면적 정서 교감이 극도로 풍부한 오케스트레이션과 맞물려 숨 막히는 서사적 카타르시스를 연출해 냅니다."
            }
        ]
    },
        ...
        sections: [
            {
                ...
                text: "스턱만은 격정적인 찬사와 함께 영화 비평을 이끌었습니다. 아날로그 프로덕션이 자아내는 실물의 숭고한 질감과 감동처럼, 《디스클로저 데이》는 특수효과의 과도한 자극을 배제하고 인물 간의 관계와 경이로움이라는 시네마틱 아트의 원초적인 즐거움을 복원시켰습니다. 극장의 불이 꺼지는 순간, 보게 될 2시간의 우주 비행은 평생 잊지 못할 경이의 체험입니다."
            }
        ]
    },
        ...
        sections: [
            {
                ...
                text: "유튜브 크리에이터 크리스 스턱만은 유튜브 비평을 통해 《원더풀스》가 보여주는 K-히어로들의 코믹하고도 장엄한 소명이 신선한 재미와 뭉클한 치유의 카타르시스를 준다고 격찬했습니다. 투박한 실물 액션과 코미디가 어우러져 세기말 세대들에게 깊은 향수를 자극하며, 박은빈의 연기력이 이 작품의 단단한 심장 역할을 한다고 보았습니다."
            }
        ]
    }
};
